...
// ! + knopka tab - näitab html koodi algus
    ...
    while($kask->fetch()){
        ...
        echo "<td>";
         ...
         if(isAdmin()){
            echo "<td><a href='?kustuta=$id'><button class='button-35'> Kustuta</button></a></td>";
         } 
            echo "</tr>";
    }
...
?>
    ...
    <form action="?">
        <label for="raamatunimi">Lisa uus raamat</label>
        <input type="text" name="raamatunimi" id="raamatunimi">
        <input type="text" name="autorinimi" id="autorinimi">
        <input type="date" name="laenupikkus" id="laenupikkus">
        <input class="button-35" type="submit" value="Lisa raamat">
    </form>
    <?php }  }  ?>
